...
- Notification delivery, widget refresh, deep links, magic-link return, upgrade preservation and offline startup still require the documented physical-device release pass.
