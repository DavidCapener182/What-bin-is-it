...
export const settingsStyles = StyleSheet.create({
  ...
  content: { width: '100%', maxWidth: 760, alignSelf: 'center', padding: 16, paddingBottom: 42, gap: 28 },
  finder: { gap: 10 },
  ...
  row: { minHeight: 72, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 11, borderBottomWidth: StyleSheet.hairlineWidth },
  ...
  segmentOption: { flex: 1, minHeight: 44, borderRadius: 9, alignItems: 'center', justifyContent: 'center' },
