...
export function createGuideScreenStyles(theme: AppTheme) {
  return StyleSheet.create({
    ...
    searchBox: { minHeight: 52, borderRadius: 16, backgroundColor: theme.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: theme.separator, paddingHorizontal: 14, alignItems: 'center', flexDirection: 'row', gap: 9 },
    ...
    input: { color: theme.text, fontSize: 16, fontWeight: '500', flex: 1, minHeight: 50 },
