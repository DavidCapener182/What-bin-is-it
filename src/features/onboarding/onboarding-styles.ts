...
export const onboardingStyles = StyleSheet.create({
  page: { flex: 1 },
  safe: { width: '100%', maxWidth: 568, alignSelf: 'center', paddingHorizontal: 22, paddingTop: 12 },
  ...
  step: { flexGrow: 1, paddingHorizontal: 22, paddingTop: 38, paddingBottom: 28, gap: 16 },
  ...
  primary: { minHeight: 52, borderRadius: 14, alignItems: 'center', justifyContent: 'center', marginTop: 12, paddingHorizontal: 16 },
