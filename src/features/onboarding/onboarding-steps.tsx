    ...
    <View style={styles.body}>
      ...
      {step === 0 ? (
        <ScrollView contentContainerStyle={styles.step} keyboardShouldPersistTaps="handled">
          ...
          <Text style={[styles.copy, { color: theme.secondaryText }]}>Find your collection dates, know which bin goes out, and get a reminder when it’s time.</Text>

          <Text style={[styles.progressLabel, { color: theme.text }]}>Your UK postcode</Text>
