  ...
  return (
    <View style={styles.page}>
      <LinearGradient colors={[theme.hero, theme.hero]} nativeID="today-setup-hero" style={[styles.setupHero, { backgroundColor: theme.hero }]}>
        <SafeAreaView nativeID="today-header-inset" edges={['top']} style={styles.heroSafeArea}>
...
export function TodayHero({
  ...
  return (
    <LinearGradient colors={[heroColour, heroColour]} nativeID="today-hero" style={[styles.hero, { backgroundColor: heroColour }]}>
      <SafeAreaView nativeID="today-header-inset" edges={['top']} style={styles.heroSafeArea}>
