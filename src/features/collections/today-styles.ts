...
export function createTodayStyles(theme: AppTheme, mode: AdaptiveLayoutMode) {
  ...
  return StyleSheet.create({
    ...
    setupHero: { paddingHorizontal: roomy ? 40 : 22, paddingTop: roomy ? 26 : 0, paddingBottom: 32, borderBottomLeftRadius: 24, borderBottomRightRadius: 24 },
    ...
    setupContent: { width: '100%', maxWidth: 640, alignSelf: 'center', padding: roomy ? 28 : 18, paddingBottom: 122, gap: 20 },
    setupCard: { backgroundColor: theme.surface, borderRadius: 22, borderWidth: StyleSheet.hairlineWidth, borderColor: theme.separator, padding: 18, gap: 12 },
    ...
    hero: { paddingHorizontal: roomy ? appLayout.residentWideGutter : 20, paddingBottom: roomy ? 20 : 16, borderBottomLeftRadius: 24, borderBottomRightRadius: 24 },
    ...
    addressLine: { minHeight: 44, flexDirection: 'row', alignItems: 'center', gap: 8, alignSelf: 'flex-start', maxWidth: '100%' },
    ...
    countdownNumber: { color: '#D7ECFF', fontFamily: appFonts.rounded, fontSize: 14, fontWeight: '800', fontVariant: ['tabular-nums'], letterSpacing: -0.4, textAlign: 'center' },
    ...
    actionCard: { backgroundColor: theme.surface, borderRadius: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: theme.separator, padding: 17, gap: 14, ...platformShadow('0 3px 12px rgba(24, 38, 59, 0.04)', { shadowColor: '#000000', shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: 5 }, elevation: 2 }) },
    ...
    collectionCard: { overflow: 'hidden', minHeight: 94, backgroundColor: theme.surface, borderRadius: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: theme.separator, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, ...platformShadow('0 3px 12px rgba(24, 38, 59, 0.04)', { shadowColor: '#000000', shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: 5 }, elevation: 2 }) },
