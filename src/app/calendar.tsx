      ...
      <View style={styles.page}>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.endCard}>
            ...
            <Text style={styles.endTitle}>{upcoming.length ? 'More dates will appear here' : 'No upcoming dates saved'}</Text>
            <Text style={styles.endCopy}>{upcoming.length ? 'Your schedule rolls forward as verified council data arrives.' : 'Refresh this place from Today or Places to check its connected council source.'}</Text>
          </View>
        </ScrollView>
      </View>
    </AppShell>
