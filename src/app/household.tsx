...
function createStyles(theme: ReturnType<typeof useAppTheme>) { return StyleSheet.create({
  page: { flex: 1, backgroundColor: theme.background }, header: { minHeight: 72, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: theme.surface, borderBottomColor: theme.separator, borderBottomWidth: StyleSheet.hairlineWidth }, back: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' }, kicker: { color: theme.accent, fontSize: 13, fontWeight: '700' }, title: { color: theme.text, fontSize: 30, lineHeight: 35, fontWeight: '700' }, content: { width: '100%', maxWidth: 760, alignSelf: 'center', padding: 16, paddingBottom: 120, gap: 16 }, privacy: { flexDirection: 'row', gap: 10, padding: 14, backgroundColor: theme.accentSoft, borderRadius: 14 }, privacyText: { color: theme.text, flex: 1, fontSize: 14, lineHeight: 19 }, card: { backgroundColor: theme.surface, borderColor: theme.separator, borderWidth: StyleSheet.hairlineWidth, borderRadius: 18, padding: 18, gap: 12 }, cardKicker: { color: theme.secondaryText, fontSize: 12, fontWeight: '700', letterSpacing: 0.7 }, cardTitle: { color: theme.text, fontSize: 22, lineHeight: 27, fontWeight: '700' }, cardBody: { color: theme.secondaryText, fontSize: 14, lineHeight: 20 }, input: { minHeight: 50, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: theme.separator, backgroundColor: theme.background, color: theme.text, paddingHorizontal: 14, fontSize: 16 }, primary: { minHeight: 50, borderRadius: 13, backgroundColor: theme.accentFill, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 18 }, primaryText: { color: '#FFFFFF', fontSize: 16, fontWeight: '700' }, disabled: { opacity: 0.45 }, hero: { backgroundColor: theme.hero, borderRadius: 20, padding: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, heroKicker: { color: theme.heroSecondary, fontSize: 12, fontWeight: '700', letterSpacing: 0.8 }, heroTitle: { color: theme.heroText, fontSize: 28, fontWeight: '700', marginTop: 5 }, heroBody: { color: theme.heroSecondary, fontSize: 14, marginTop: 4 }, collection: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 4 }, dot: { width: 12, height: 12, borderRadius: 6 }, collectionCopy: { flex: 1 }, assignTitle: { color: theme.text, fontSize: 15, fontWeight: '700', marginTop: 4 }, people: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, person: { minHeight: 44, flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 12, paddingHorizontal: 11, borderColor: theme.separator, borderWidth: StyleSheet.hairlineWidth, backgroundColor: theme.accentSoft }, personText: { color: theme.accent, fontWeight: '700' }, rowBetween: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, smallButton: { flexDirection: 'row', alignItems: 'center', gap: 6, minHeight: 44, paddingHorizontal: 12, borderRadius: 12, backgroundColor: theme.accentSoft }, smallButtonText: { color: theme.accent, fontWeight: '700' }, memberRow: { flexDirection: 'row', gap: 10, alignItems: 'center', paddingVertical: 6 }, memberName: { color: theme.text, fontSize: 16, fontWeight: '700' }, activityRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 5 }, activityText: { color: theme.text, flex: 1, fontSize: 14, lineHeight: 19 }, error: { color: theme.danger, fontSize: 14, lineHeight: 19 }, success: { color: theme.success, fontSize: 14, lineHeight: 19 }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 28, gap: 14 }, centerTitle: { color: theme.text, fontSize: 26, fontWeight: '700', textAlign: 'center' }, centerBody: { color: theme.secondaryText, fontSize: 16, lineHeight: 23, textAlign: 'center', maxWidth: 420 }, or: { color: theme.secondaryText, textAlign: 'center' },
}); }
