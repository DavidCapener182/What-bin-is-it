    ...
    <AppShell activeRoute="/guide">
      ...
      <View style={styles.page}>
        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          <View accessibilityRole="tablist" style={styles.modePicker}>
            <Pressable accessibilityRole="tab" accessibilityState={{ selected: mode === 'guide' }} onPress={() => setMode('guide')} style={[styles.mode, mode === 'guide' && styles.modeActive]}><Ionicons color={mode === 'guide' ? appColours.brand : '#688184'} name="search-outline" size={17} /><Text style={[styles.modeText, mode === 'guide' && styles.modeTextActive]}>Bin guide</Text></Pressable>
            <Pressable accessibilityRole="tab" accessibilityState={{ selected: mode === 'services' }} onPress={() => setMode('services')} style={[styles.mode, mode === 'services' && styles.modeActive]}><Ionicons color={mode === 'services' ? appColours.brand : '#688184'} name="map-outline" size={17} /><Text style={[styles.modeText, mode === 'services' && styles.modeTextActive]}>Local services</Text></Pressable>
          </View>

          {mode === 'guide' ? (
            <>
              <View style={styles.searchBox}><Ionicons color="#4A7475" name="search" size={19} /><TextInput accessibilityLabel="Search household items" autoCapitalize="none" autoCorrect={false} clearButtonMode="while-editing" onChangeText={(value) => { setQuery(value); setSelected(undefined); }} placeholder={`Search ${guideItemCount}+ household items…`} placeholderTextColor="#748B8D" returnKeyType="search" style={styles.input} value={query} /></View>
...
const styles = StyleSheet.create({
  ...
  kicker: { color: '#9A5C1F', fontFamily: appFonts.text, fontSize: 12, letterSpacing: 1, fontWeight: '700' },
  ...
  chipsLabel: { color: '#607A7D', fontSize: 12, letterSpacing: 0.75, fontWeight: '700', marginRight: 2 },
  chip: { minHeight: 44, paddingHorizontal: 12, justifyContent: 'center', borderRadius: 14, backgroundColor: '#FAEEDB' },
  chipText: { color: '#7D4F1B', fontSize: 12, fontWeight: '800' },
  guideHeader: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', marginTop: 4 },
  sectionKicker: { color: '#5B797B', fontFamily: appFonts.text, fontSize: 12, letterSpacing: 0.85, fontWeight: '700' },
  ...
  checkText: { color: '#82531D', fontSize: 12, letterSpacing: 0.35, fontWeight: '700' },
  ...
  guideDetail: { color: '#587477', fontSize: 13, lineHeight: 18, marginTop: 3, fontWeight: '500' },
  localNote: { flexDirection: 'row', alignItems: 'flex-start', gap: 5, marginTop: 9, backgroundColor: '#EDF4EF', borderRadius: 8, padding: 7 },
  localNoteText: { color: '#587477', fontSize: 12, lineHeight: 16, flex: 1, fontWeight: '600' },
  ...
  emptyText: { color: '#5D7679', fontSize: 13, textAlign: 'center', lineHeight: 18, marginTop: 4, maxWidth: 270 },
  ...
  servicesText: { color: '#B6D4C6', fontSize: 12.5, lineHeight: 17, marginTop: 4, fontWeight: '500' },
  ...
  locationCopy: { flex: 1 },
  locationLabel: { color: '#3D746E', fontSize: 12, letterSpacing: 0.75, fontWeight: '700' },
  ...
  servicesNoteText: { flex: 1, color: '#5F787B', fontSize: 12, lineHeight: 17 },
  serviceResults: { gap: 10 },
  resultCount: { color: '#4E7173', fontSize: 12, fontWeight: '800' },
  ...
  serviceType: { color: '#0A756B', fontSize: 12, marginTop: 3, fontWeight: '800' },
  serviceAddress: { color: '#5B7477', fontSize: 12, lineHeight: 17, marginTop: 3, fontWeight: '600' },
  serviceMaterials: { color: '#315A5C', fontSize: 12, lineHeight: 17, marginTop: 5, fontWeight: '700' },
