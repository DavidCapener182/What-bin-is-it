...
function createStyles(theme: AppTheme) {
  return StyleSheet.create({
    ...
    kicker: { color: theme.accent, fontFamily: appFonts.text, fontSize: 12, letterSpacing: 0.8, fontWeight: '700' },
    ...
    notice: { minHeight: 60, borderRadius: 16, borderWidth: StyleSheet.hairlineWidth, padding: 16, flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
    ...
    stickyAction: { backgroundColor: theme.surface, borderTopColor: theme.separator, borderTopWidth: StyleSheet.hairlineWidth },
    stickyActionInner: { minHeight: 68, paddingHorizontal: 16, paddingVertical: 8, flexDirection: 'row', alignItems: 'center', gap: 10 },
    empty: { borderRadius: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: theme.separator, backgroundColor: theme.surface, padding: 32, alignItems: 'center' },
