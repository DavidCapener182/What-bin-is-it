      ...
      <section className="overview-grid">
        <article className="panel">
          ...
          <div className="connection-list">
            <div className="connection-row"><div><strong>Resident reach</strong><br /><span>Active, currently linked and all-time random installation IDs, recorded separately from optional app-improvement analytics</span></div></div>
