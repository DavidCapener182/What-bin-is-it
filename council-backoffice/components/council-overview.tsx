  ...
  return (
    <>
      <PageHeader
        ...
        description="A privacy-preserving operational view of active, currently linked and all-time resident installations, verified gateway checks and published council content."
      />
